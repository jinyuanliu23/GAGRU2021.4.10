...
from model.pytorch.dcrnn_cell import GAT_GRU
...
class EncoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, **model_kwargs):
        ...
        self.gagru_layers = nn.ModuleList(
            [GAT_GRU(self.rnn_units, adj_mx, self.num_nodes
...
class DecoderModel(nn.Module, Seq2SeqAttrs):
    def __init__(self, adj_mx, **model_kwargs):
        ...
        self.gagru_layers = nn.ModuleList(
            [GAT_GRU(self.rnn_units, adj_mx,  self.num_nodes) for _ in range(self.num_rnn_decode_layers)])
